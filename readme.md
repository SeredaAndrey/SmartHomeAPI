...
PATCH: /admin - редагування даних облікового запису адміна (з токеном адміна)
...
PATCH: /user/userID - редагування даних облікового запису користувача (з токеном адміна)
